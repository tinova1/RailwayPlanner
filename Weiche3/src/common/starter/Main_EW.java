...
public class Main_EW {
	...
	public static void main(String[] args) {
		 ...
		 * p13.addArc(200, .5, RotDir.POS); final Path p24 = new Path(new LineSeg(new
		 * Point(-50,0),new Point(-20,0))); p24.addArc(200, .7, RotDir.POS); PathKr ibw
		 * = new PathKr(16.5,rail,p13,p24);
		 */
